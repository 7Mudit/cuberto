  ...
  return (
    <div className="flex flex-col pl-[20px] sm:pl-[134px] w-full items-start justify-center gap-5">
      <div className="w-full">
        <span
          className={`text-[46px] leading-[41px] xs:text-[62px] xs:leading-[55px] xl:text-[125px] xl:leading-[112px] ${martel.className}`}
        >
          We{" "}
          <span className={` ${robot.className} !text-[400] !italic`}>
            develop
          </span>
        </span>
      </div>
      ...
      <div className="flex flex-row items-center justify-center gap-2">
        ...
        <div
          className={`text-[24px] leading-[41px] xs:text-[62px] xs:leading-[55px] xl:text-[125px] xl:leading-[112px] ${martel.className}`}
        >
          digital products{" "}
        </div>
      </div>
