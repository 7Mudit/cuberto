  ...
  return (
    <>
      <div className="bg-black w-full h-auto rounded-t-[60px] px-7 sm:px-16 py-16 relative">
        ...
        <div className="flex md:flex-row flex-col gap-[70px] lg:gap-[100px] py-32">
          <div
            className="w-full md:w-5/12 flex flex-col gap-[50px] lg:gap-[100px]"
            onMouseOver={() => {
              setIsActive(true);
            }}
            onMouseLeave={() => {
          ...
          <div
            className="w-full md:w-5/12 md:pt-52 flex flex-col gap-[100px] lg:gap-[150px]"
            onMouseOver={() => {
              setIsActive(true);
            }}
            onMouseLeave={() => {
